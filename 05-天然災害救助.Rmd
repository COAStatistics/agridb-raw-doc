...
-----------------|-------------------|-------------|----------
年度             | year              | char(3)     | 民國年
災害名稱         | evt_name          | varchar(50) | 災害名稱
發生日期         | dateTime          | varchar(50) | 災害發生日期
縣市             | county            | varchar(6)  | 縣市
鄉鎮             | town              | varchar(8)  | 鄉鎮
農戶姓名         | ownerName         | varchar(50) | 所有權人姓名
身份證號         | ownerID           | char(10)    | 所有權人身分證
地址             | addr              | text        | 地址
地段             | landNo7           | varchar(7)  | 地段(7碼)
地段中文         | landNo7CHN        | varchar(50) | 地段中文
地號             | landNo8           | varchar(9)  | 地號
本筆面積         | landArea          | float       | 單位是公頃
權利面積         | landRightsArea    | float       | 單位是公頃
申請者           | appName           | varchar(50) | 實際耕作者/申請者
申請作物         | applyCrop         | varchar(50) | 申請作物
申請面積         | applyArea         | float       | 單位是公頃
申請受害率       | applyDamageRate   | varchar(50) | 百分比
核定結果         | approveCheck      | varchar(50) | 符合；不符
核定作物         | approveCrop       | varchar(50) | 核定作物
核定面積         | approveArea       | float       | 單位是公頃
核定受害率       | approveDamageRate | varchar(50) | 百分比
補助方式         | subsidyType       | varchar(50) | 現金救助
